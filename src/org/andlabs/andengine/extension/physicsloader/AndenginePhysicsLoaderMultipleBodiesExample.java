...
public class AndenginePhysicsLoaderMultipleBodiesExample extends
		SimpleBaseGameActivity implements BodyChangedListener {
	...
	private ITextureRegion mSimpleAssetTextureRegion;

	private Scene mScene;

	private PhysicsWorld mPhysicsWorld;
	private Sprite mMultiFixtureAsset;
	private Sprite mSimpleAsset;
	...
	protected void onCreateResources() {
		...
		this.mSimpleAssetTextureRegion = BitmapTextureAtlasTextureRegionFactory
				.createFromAsset(this.mBitmapTextureAtlas, this,
						"simple_asset.png", 0, 256);
		this.mCircleFaceTextureRegion = BitmapTextureAtlasTextureRegionFactory
				.createTiledFromAsset(this.mBitmapTextureAtlas, this,
						"face_circle_tiled.png", 0, 512, 2, 1); // 64x32
	...
	protected Scene onCreateScene() {
		...
		this.mMultiFixtureAsset = new Sprite(
				mSimpleAssetTextureRegion.getWidth() - 100, CAMERA_HEIGHT
						- mBigAssetTextureRegion.getHeight(),
				this.mBigAssetTextureRegion, vertexBufferObjectManager);
		this.mSimpleAsset = new Sprite(0, CAMERA_HEIGHT
				- mBigAssetTextureRegion.getHeight(),
				this.mSimpleAssetTextureRegion, vertexBufferObjectManager);

		this.mScene.attachChild(mMultiFixtureAsset);
	...
	public IAreaShape onBodyChanged(final String pBodyName) {
		// return the IAreaShape fitting the body's name
		if (pBodyName.equals("multi_fixture_asset")) {
			return mMultiFixtureAsset;
		} else if (pBodyName.equals("big_asset")) {
			return mSimpleAsset;
		}
		return null;
	}
